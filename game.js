// ============================================
// 🎮 لعبة ماريو - المحرك الرئيسي (معدل)
// ============================================

'use strict';

// جعل الكلاس متاحاً قبل التحميل
if (!window.MarioGame) {
    window.MarioGame = class MarioGame {
        constructor() {
        ...
        init() {
            ...
            if (!this.canvas) {
                console.log('⚠️ Canvas غير موجود، جاري البحث...');
                setTimeout(() => {
                    this.canvas = document.getElementById('game-canvas');
                    if (this.canvas) {
                        this.setupCanvas();
        ...
        showScreen(screenName) {
            ...
            if (targetScreen) {
                ...
                // إذا كانت شاشة اللعب، نبدأ اللعبة
                if (screenName === 'game') {
                    setTimeout(() => {
